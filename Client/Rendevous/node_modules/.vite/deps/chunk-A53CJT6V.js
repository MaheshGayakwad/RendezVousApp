...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react2.useRef)(null);
  const popper2 = (0, import_react2.useRef)(null);
  const instance = (0, import_react2.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react2.useRef)(() => {
  });
  const setupPopper = (0, import_react2.useCallback)(() => {
    var _a;
  ...
  const referenceRef = (0, import_react2.useCallback)(
    (node) => {
  ...
  const getReferenceProps = (0, import_react2.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react2.useCallback)(
    (node) => {
  ...
  const getPopperProps = (0, import_react2.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react2.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react2.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react4.useState)(props.defaultIsOpen || false);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react6.useRef)();
  const clearEnterTimeout = (0, import_react6.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react6.useRef)();
  const clearExitTimeout = (0, import_react6.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react6.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react6.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react6.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
  ...
  const getTooltipPositionerProps = (0, import_react6.useCallback)(
...
function createGeneratorEasing(options, scale3 = 100) {
  ...
  return {
    type: "keyframes",
    ease: (progress2) => generator.next(duration * progress2).value / scale3,
...
var Tooltip = forwardRef((props, ref) => {
  ...
  let trigger;
  if (shouldWrap) {
    trigger = (0, import_jsx_runtime3.jsx)(
      chakra.span,
      {
    ...
    const child = import_react52.Children.only(children);
    trigger = (0, import_react52.cloneElement)(
      child,
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    trigger,
    (0, import_jsx_runtime3.jsx)(AnimatePresence, { children: tooltip.isOpen && (0, import_jsx_runtime3.jsx)(Portal, { ...portalProps, children: (0, import_jsx_runtime3.jsx)(
      chakra.div,
      {
        ...
        children: (0, import_jsx_runtime3.jsxs)(
          MotionDiv,
          {
            ...
            children: [
              label,
              hasAriaLabel && (0, import_jsx_runtime3.jsx)(chakra.span, { srOnly: true, ...srOnlyProps, children: ariaLabel }),
              hasArrow && (0, import_jsx_runtime3.jsx)(
                chakra.div,
                {
...
//# sourceMappingURL=chunk-A53CJT6V.js.map
